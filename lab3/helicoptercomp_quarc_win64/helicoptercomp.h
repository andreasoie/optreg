...
#ifndef RTW_HEADER_helicoptercomp_h_
#define RTW_HEADER_helicoptercomp_h_
#include <math.h>
#include <string.h>
#ifndef helicoptercomp_COMMON_INCLUDES_
#define helicoptercomp_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* helicoptercomp_COMMON_INCLUDES_ */

#include "helicoptercomp_types.h"
...
#define helicoptercomp_rtModel         RT_MODEL_helicoptercomp_T
...
#define rtB                            helicoptercomp_B
#define BlockIO                        B_helicoptercomp_T
#define rtX                            helicoptercomp_X
#define ContinuousStates               X_helicoptercomp_T
#define rtXdot                         helicoptercomp_XDot
#define StateDerivatives               XDot_helicoptercomp_T
#define tXdis                          helicoptercomp_XDis
#define StateDisabled                  XDis_helicoptercomp_T
#define rtP                            helicoptercomp_P
#define Parameters                     P_helicoptercomp_T
#define rtDWork                        helicoptercomp_DW
#define D_Work                         DW_helicoptercomp_T

/* Parameters (default storage) */
struct P_helicoptercomp_T_ {
  ...
  real_T HILInitialize_POWatchdog;     /* Expression: watchdog_pwm_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T deg_Value;                    /* Expression: 180
                                        * Referenced by: '<Root>/deg'
                                        */
...
struct tag_RTM_helicoptercomp_T {
  const char_T *path;
...
extern P_helicoptercomp_T helicoptercomp_P;

/* Block signals (default storage) */
extern B_helicoptercomp_T helicoptercomp_B;

/* Continuous states (default storage) */
extern X_helicoptercomp_T helicoptercomp_X;

/* Block states (default storage) */
extern DW_helicoptercomp_T helicoptercomp_DW;
...
extern void helicoptercomp_initialize(void);
extern void helicoptercomp_output0(void);
extern void helicoptercomp_update0(void);
extern void helicoptercomp_output(int_T tid);
extern void helicoptercomp_update(int_T tid);
extern void helicoptercomp_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicoptercomp_rtModel *helicoptercomp(void);
...
extern RT_MODEL_helicoptercomp_T *const helicoptercomp_M;
 ...
 *
 * '<Root>' : 'helicoptercomp'
 * '<S1>'   : 'helicoptercomp/Conversion'
 * '<S2>'   : 'helicoptercomp/Degrees to Radians'
 * '<S3>'   : 'helicoptercomp/Elevation controller'
 * '<S4>'   : 'helicoptercomp/Helicopter_interface'
 * '<S5>'   : 'helicoptercomp/Pitch controller'
 * '<S6>'   : 'helicoptercomp/Elevation controller/If Action Subsystem'
 * '<S7>'   : 'helicoptercomp/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helicoptercomp/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helicoptercomp/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helicoptercomp/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helicoptercomp/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helicoptercomp/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helicoptercomp/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicoptercomp_h_ */
