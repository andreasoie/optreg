...
typedef struct {
  real_T FromWorkspace;                /* '<S1>/From Workspace' */
  real_T FromWorkspace1;               /* '<S1>/From Workspace1' */
...
typedef struct {
  ...
  real_T TmpRTBAtToFile2Inport1_Buffer[2];/* synthesized block */
  real_T TmpRTBAtToFileInport1_Buffer[6];/* synthesized block */
  ...
  struct {
    void *LoggedData;
  } Rawinputs_PWORK;                   /* '<Root>/Raw inputs' */

  struct {
    void *LoggedData;
  } States_PWORK;                      /* '<Root>/States' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWorkspace2_PWORK;              /* '<S5>/From Workspace2' */
  ...
  struct {
    int_T PrevIndex;
  } FromWorkspace2_IWORK;              /* '<S5>/From Workspace2' */
