  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% helicopter_DW.TmpRTBAtToFile2Inport1_Buffer
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 70;
	
	  ;% helicopter_DW.TmpRTBAtToFileInport1_Buffer
	  section.data(15).logicalSrcIdx = 14;
	  ...
	  ;% helicopter_DW.Rawinputs_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 19;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_DW.States_PWORK.LoggedData
  ...
  targMap.checksum0 = 2989560243;
  targMap.checksum1 = 1440690026;
  targMap.checksum2 = 3960055050;
  targMap.checksum3 = 737788429;
